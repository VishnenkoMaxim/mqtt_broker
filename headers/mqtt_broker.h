...
public:
    ...
    ServerCfgData(const string &_path, const size_t &_log_max_size, const size_t &log_max_files) : log_file_path(_path), log_max_size(_log_max_size), log_max_files(log_max_files) {
        //
    }
